...
import { SelectResaturant } from "../components/Selecoes/SelectRestaurant"
...
//    método   recebe uma string como argumento e filtra os restaurantes 
    ...
    />
            <hr/>
               ...
               <form>
          <input value={search} onChange={handleSearch} label="Restaurante" variant="outlined" fullWidth/>
          </form>
          <SelectResaturant list={categorias} action={handleSearchCategory} />
